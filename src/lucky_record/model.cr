...
class LuckyRecord::Model
  ...
  macro inherited
    ...
    ASSOCIATIONS = [] of {name: Symbol, foreign_key: Symbol, through: Symbol}
  ...
  macro association(table_name, foreign_key = nil, through = nil)
    {% ASSOCIATIONS << {name: table_name.id, foreign_key: foreign_key, through: through} %}
  end
end
