...
class LuckyRecord::Model
  ...
  macro table(table_name, primary_key_type = LuckyRecord::PrimaryKeyType::Serial)
  ...
  macro table
    setup_autogenerated_columns(LuckyRecord::PrimaryKeyType::Serial)
    {{yield}}
    setup(:{{ run "../run_macros/infer_table_name.cr", @type.id }}, LuckyRecord::PrimaryKeyType::Serial)
  end
